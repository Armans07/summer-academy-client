...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="bg-orange-400 dark:bg-gray-900">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <img src={logo} className="h-20 mr-3" alt="FlowBite Logo" />
                            <span className="self-center text-1xl font-bold whitespace-nowrap dark:text-white">Sports Academy</span>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://flowbite.com/" className="hover:underline">Summer Champ</a>
                                    </li>
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-black sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">SportAcademy™</a>. All Rights Reserved.
                        </span>
