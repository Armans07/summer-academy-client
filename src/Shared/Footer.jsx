                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            ...
                            <span className="self-center text-1xl font-semibold whitespace-nowrap dark:text-white">Summer champ</span>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">SummerChamp™</a>. All Rights Reserved.
                        </span>
